...
export class PurchaseService implements PurchaseServiceInterface {
    ...
    /**
     * creating Purchase from PurchaseTemplate
     * @param purchaseTemplate PurchaseTemplate
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public createFromTemplate(purchaseTemplate?: PurchaseTemplate, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Purchase>;
    public createFromTemplate(purchaseTemplate?: PurchaseTemplate, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Purchase>>;
    public createFromTemplate(purchaseTemplate?: PurchaseTemplate, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Purchase>>;
    public createFromTemplate(purchaseTemplate?: PurchaseTemplate, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<Purchase>(`${this.configuration.basePath}/purchase/fromTemplate`,
            purchaseTemplate,
            {
